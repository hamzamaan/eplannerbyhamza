...
if(isset($_POST['submit']))
{
	...
	// else
	// 	$userType='dummy';
	$insert = mysqli_query($con, "INSERT INTO `AddBusiness`(b_name, city, area, location,open_days,services,b_charges,b_contact,image) VALUES('$bName', '$city', '$area', '$loaction','$opendays','$service','$bcharges','$bcontact','$imagename')");
	if($insert)
	{
